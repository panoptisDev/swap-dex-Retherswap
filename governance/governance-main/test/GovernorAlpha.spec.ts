...
describe('GovernorAlpha', () => {
  ...
  it('rether', async () => {
    const balance = await rether.balanceOf(wallet.address)
  ...
  it('governor', async () => {
    ...
    const retherFromGovernor = await governorAlpha.rether()
    expect(retherFromGovernor).to.be.eq(rether.address)
  })
})
